...
do
  ...
  do
    ...
    chroot $root apt-get install --force-yes -y -o "DPkg::Options::=--force-confold" vim build-essential apt-utils gpgv libssl-dev zlib1g-dev curl git-core lsb-release uuid-dev libreadline-dev pkg-config g++ libboost-dev libevent-dev automake libtool flex bison
