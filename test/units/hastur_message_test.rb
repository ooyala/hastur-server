...
class TestClassHasturMessage < MiniTest::Unit::TestCase
  ...
  def test_serialize
    ...
    json1= "{\"type\":\"rawdata\",\"envelope\":{\"version\":1,\"type_id\":6,\"to\":\"#{NONE_UUID}\",\"from\":\"be7f4980-6a1f-4120-b0ce-26de709afcf6\",\"ack\":0,\"resend\":0,\"sequence\":88888,\"timestamp\":1329865874428623,\"uptime\":12.4,\"hmac\":\"\",\"routers\":[]},\"payload\":\"a b c d e f g\",\"zmq_parts\":[]}"
